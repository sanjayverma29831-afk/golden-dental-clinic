...
export function VideoSection3({
  totalFrames = 150,
  title = "GOLDEN DENTAL CLINIC",
  subtitle = "Premium Care. Right Here in Badnagar.",
  description = "Experience modern dental care with a focus on comfort, precision and confident smiles.",
  address = "131, M.G. Road,\nNear Royal Progressive School,\nNayapura, Badnagar,\nDistrict Ujjain, Madhya Pradesh"
}: VideoSection3Props) {
  ...
  // Constants for Video 3
  const frameExtension = "webp";
  const framePrefix = "/frames/video_3/frame_";
    ...
    >
      <div className="sticky top-0 w-full h-screen overflow-hidden bg-[#1a1a1a]">
        ...
        <canvas 
          ...
          aria-label={`Exterior view of ${title}`}
        />

        {/* Subtle Gradient Overlay for Button Legibility ONLY */}
